---
title: "RNASeq_varCall_Report_20190923"
author: "Ji-Dung Luo"
...
tabV3 <- tabV3[tabV3$Grp %in% 1:8,]
#
tabV3$Grp <- factor(tabV3$Grp,levels = 1:8,ordered = TRUE)
tabV3 <- tabV3[order(tabV3$Grp),]
#
matV3 <- tabV3[,c(names(tabV3)[grepl(names(tabV3),pattern='^AF_C')],
                  names(tabV3)[grepl(names(tabV3),pattern='^AF_F')],
                  names(tabV3)[grepl(names(tabV3),pattern='^AF_Z')],
                  names(tabV3)[grepl(names(tabV3),pattern='^AF_Y')])]
rownames(matV3) <- tabV3$variant
colTab <- data.frame(Cell=c(rep("C",3),rep("F",3),rep("Z",3),rep("Y",3)))
rownames(colTab) <- colnames(matV3)
colTab$Cell <- factor(colTab$Cell,levels = c("C","F","Z","Y"))
...
message("Group 1")
set.seed(0)
pheatmap(matV3[rownames(matV3)%in%tabV3$variant[tabV3$Grp==1],],
         cluster_cols = FALSE,cluster_rows = FALSE,
         color = colorRampPalette(c("white", "red"))(100),
         annotation_row = rowTab[rownames(rowTab)%in%tabV3$variant[tabV3$Grp==1],],
         annotation_col = colTab,
         show_rownames = FALSE,show_colnames = FALSE)
#
message("Group 2")
set.seed(0)
pheatmap(matV3[rownames(matV3)%in%tabV3$variant[tabV3$Grp==2],],
         cluster_cols = FALSE,cluster_rows = FALSE,
         color = colorRampPalette(c("white", "red"))(100),
         annotation_row = rowTab[rownames(rowTab)%in%tabV3$variant[tabV3$Grp==2],],
         annotation_col = colTab,
         show_rownames = FALSE,show_colnames = FALSE)
#
message("Group 3")
set.seed(0)
pheatmap(matV3[rownames(matV3)%in%tabV3$variant[tabV3$Grp==3],],
         cluster_cols = FALSE,cluster_rows = FALSE,
         color = colorRampPalette(c("white", "red"))(100),
         annotation_row = rowTab[rownames(rowTab)%in%tabV3$variant[tabV3$Grp==3],],
         annotation_col = colTab,
         show_rownames = FALSE,show_colnames = FALSE)
#
message("Group 4")
set.seed(0)
pheatmap(matV3[rownames(matV3)%in%tabV3$variant[tabV3$Grp==4],],
         cluster_cols = FALSE,cluster_rows = FALSE,
         color = colorRampPalette(c("white", "red"))(100),
         annotation_row = rowTab[rownames(rowTab)%in%tabV3$variant[tabV3$Grp==4],],
         annotation_col = colTab,
         show_rownames = FALSE,show_colnames = FALSE)
#
message("Group 5")
set.seed(0)
pheatmap(matV3[rownames(matV3)%in%tabV3$variant[tabV3$Grp==5],],
         cluster_cols = FALSE,cluster_rows = FALSE,
         color = colorRampPalette(c("white", "red"))(100),
         annotation_row = rowTab[rownames(rowTab)%in%tabV3$variant[tabV3$Grp==5],],
         annotation_col = colTab,
         show_rownames = FALSE,show_colnames = FALSE)
#
message("Group 6")
set.seed(0)
pheatmap(matV3[rownames(matV3)%in%tabV3$variant[tabV3$Grp==6],],
         cluster_cols = FALSE,cluster_rows = FALSE,
         color = colorRampPalette(c("white", "red"))(100),
         annotation_row = rowTab[rownames(rowTab)%in%tabV3$variant[tabV3$Grp==6],],
         annotation_col = colTab,
         show_rownames = FALSE,show_colnames = FALSE)
#
message("Group 7")
set.seed(0)
pheatmap(matV3[rownames(matV3)%in%tabV3$variant[tabV3$Grp==7],],
         cluster_cols = FALSE,cluster_rows = FALSE,
         color = colorRampPalette(c("white", "red"))(100),
         annotation_row = rowTab[rownames(rowTab)%in%tabV3$variant[tabV3$Grp==7],],
         annotation_col = colTab,
         show_rownames = FALSE,show_colnames = FALSE)
#
message("Group 8")
set.seed(0)
pheatmap(matV3[rownames(matV3)%in%tabV3$variant[tabV3$Grp==8],],
         cluster_cols = FALSE,cluster_rows = FALSE,
         color = colorRampPalette(c("white", "red"))(100),
         annotation_row = rowTab[rownames(rowTab)%in%tabV3$variant[tabV3$Grp==8],],
         annotation_col = colTab,
         show_rownames = FALSE,show_colnames = FALSE)
#
...
message("No ADAR-editting site detected")
# rdSeq <- rd[names(rd)%in%varList]
# ab <- consensusMatrix(rdSeq$seq)
# ncTab <- ab[1:4,]
# pcTab <- ncTab/colSums(ncTab)
